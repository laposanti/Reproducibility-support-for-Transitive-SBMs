# Variable-K directed DCSBM sampler.
#
# This file keeps the public DCSBM fitting entry points used by the
# reproduction scripts. Reusable update and likelihood helpers live in
# helper_folder/models/dcsbm/dcsbm_variable_k_helpers.R.

library(dplyr)
library(mcclust)
library(mcclust.ext)

source("helper_folder/models/dcsbm/dcsbm_variable_k_helpers.R", chdir = FALSE)
