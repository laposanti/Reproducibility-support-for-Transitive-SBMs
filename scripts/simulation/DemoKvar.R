...
# OBSOLETE ENTRYPOINT NOTE:
# scripts/simulation/sim_study.R is the legacy simulation driver.
# DemoKvar.R is the active runner and is what the cluster launcher should call.
